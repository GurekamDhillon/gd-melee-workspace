...
MOVE_KEYS = ["jab", "rapid_jab_start", "rapid_jab", "rapid_jab_end", "dash_attack", "ftilt", "utilt", "dtilt",
             ...
             "cape_start", "cape_vanish", "cape_attack"]
...
emit("jab", [r11], [], extra=[(c, [(30 << 26) | 1], "x") for c in (3,5,7,9)] + [(1, [(30 << 26) | 1], "RapidJab flag on (x2218_b2) at counter 1 (checkAttack11 clears it after the first frame): first A release -> Attack100Start")],
